...
class BaseModel(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.loss_integral_num_sample_per_step = kwargs['loss_integral_num_sample_per_step']
        self.hidden_size = kwargs['hidden_size']
        self.num_event_types = kwargs['num_event_types']  # not include [PAD], [BOS], [EOS]
        self.num_event_types_pad = kwargs['num_event_types_pad']  # include [PAD], [BOS], [EOS]
        ...
        self.gen_config = kwargs['thinning']
        self.event_sampler = None
        self.device = kwargs['device']
        self.use_mc_samples = kwargs['use_mc_samples']
    ...
    def predict_multi_step_since_last_event(self, batch, forward=False):
        """
        Multi-step prediction since the event in the sequence.

        Args:
            time_seq: [batch_size, seq_len].
            time_delta_seq: [batch_size, seq_len].
            type_seqs: [batch_size, seq_len].
            num_step: num of steps for prediction

        Returns:
            tuple: predicted dtime and type, [batch_size, seq_len].
        """
