...
from tapt_plus import TAPT_PLUS
...
model_list = {'SASRec': {'model': SASRec, 'config': {'d_model': 64, 'p_drop': 0.1, 'depth': 2, 'max_len': None, 'n_head': 4, 'exp_factor': 4}},
              'TAPT_PLUS': {'model': TAPT_PLUS, 'config': {'d_model': 64, 'p_drop': 0.1, 'depth': 2, 'max_len': None, 'n_head': 4, 'exp_factor': 4, 'd_time': 72, 'd_all': 64, 's_experts': 2, 'p_experts': 3, 't_experts': 3, 'num_layers': 2}},
              }
#aaaaaaaaa
if __name__ == '__main__':
    # 'Brightkite', 'Gowalla', 'Weeplaces', 'NYC', 'TKY', 'SIN'
    for data_name in ['TKY']:
